namespace battlecity
{
    class Settings
    {
        ...
        public const long SCHEDULE_EARLY_MOVE = -400;                              // Time before end of tick to post the backup move
        public const long SCHEDULE_FINAL_MOVE = -200;                               // Time before end of tick to post the final move
    }
}
